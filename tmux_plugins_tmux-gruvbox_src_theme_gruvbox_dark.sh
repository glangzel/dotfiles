...
theme_set_dark() {
  ...
  tmux_append_seto "status-left" "#[bg=${col_yellow2},fg=${col_bg1},bold] ${_left_status_a} #[bg=${col_bg2},fg=${col_yellow2},bold,noitalics,nounderscore]|#[bg=${col_bg2},fg=${col_yellow2},bold,noitalics,nounderscore]"
  ...
  tmux_append_setwo "window-status-current-format" "#[bg=${col_yellow2},fg=${col_bg1},bold,noitalics,nounderscore]#[bg=${col_yellow2},fg=${col_bg2},bold] #I |#[bg=${col_yellow2},fg=${col_bg2},bold] #W#{?window_zoomed_flag,*Z,} #{?window_end_flag,#[bg=${_current_window_status_format_bg}],#[bg=${col_bg1}]}#[fg=${col_yellow2},bold,noitalics,nounderscore]"
